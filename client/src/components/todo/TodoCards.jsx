  ...
  return (
    <div className='p-3 todo-card'>
        ...
        <div className='d-flex justify-content-around card-icon-head'>
            <div className='d-flex justify-content-around card-icon-head px-2 py-1' onClick={() =>{
            display("block")
           }}><GrDocumentUpdate className='card-icons'/>Update</div>
           <div className='d-flex justify-content-around  card-icon-head px-2 py-1 text-danger' onClick={() =>{
            delid(id);
